...
def range_image_to_point_cloud_fast(range_image):
    depth_range = np.exp2(range_image*6)-1
...
def range_image_to_point_cloud_fast_nuscenes(range_image):
    depth_range = np.exp2(range_image*6.5)-1
    #depth_range = range_image * 104
...
def point_cloud_to_range_image(point_cloud, return_remission = False):
...
def point_cloud_array_to_range_image(point_cloud):
    laser_scan = LaserScan()
